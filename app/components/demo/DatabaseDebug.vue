...
function editRecord(record: DebugRecord) {
      ...
      <Card>
        ...
        <CardContent class="pt-0">
          <div class="flex flex-wrap gap-2">
            ...
            <Button variant="destructive" size="sm" @click="clearAllRecords">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2">
            <div class="relative">
              ...
              />
              <Input v-model="searchQuery" placeholder="搜索标题..." class="pl-9 w-64" />
            </div>
          </div>
        </div>
      </CardHeader>
